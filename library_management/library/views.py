...
def issuebook_view(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            obj.bookno=request.POST.get('bookno2')
            obj.save()
...
def viewissuedbook_view(request):
    ...
    for ib in issuedbooks:
        ...
        books=list(models.Book.objects.filter(bookno=ib.bookno))
...
def viewissuedbookbystudent(request):
    ...
    for ib in issuedbook:
        books=models.Book.objects.filter(bookno=ib.bookno)
        for book in books:
...
def edit(request, id):
    ...
    return render(request,'library/edit.html',{'book':book,'form':form})